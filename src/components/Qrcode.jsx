  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-r from-pink-800 to-red-700 text-center py-10">
        <h1 className="text-2xl md:text-4xl font-bold text-white transition-transform transform hover:scale-110 duration-300 ease-in-out">🔍Snap • 📝Fill • 🚀Go!</h1>
        <p className="text-sm md:text-xl italic text-white mt-2 ">Quick & Hassle-Free!</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center px-6 md:px-16 py-12 md:py-20">
        <div className="flex flex-col items-center text-center md:text-left md:items-start md:mr-12">
          <h2 className="text-2xl md:text-4xl pb-4 font-bold bg-gradient-to-r from-pink-800 to-red-700 text-transparent bg-clip-text mb-6">
        ...
        <div className="md:ml-12 mt-12 md:mt-0 text-center md:text-right">
          <h3 className="text-2xl md:text-4xl font-bold text-pink-800 mb-2">
            Transform Your Experience with Us!
          </h3>
          <p className="text-pink-800 mb-8 text-sm md:text-lg leading-relaxed max-w-2xl">
          ...
          <button
            className="bg-gradient-to-r from-pink-800 to-red-700 text-white text-sm md:text-lg px-6 md:px-4 py-[5px] md:py-2 rounded-full shadow-lg hover:scale-105 transition-all duration-300"
