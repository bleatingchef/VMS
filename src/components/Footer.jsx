...
const Footer = () => {
  return (
    <div className="bg-gradient-to-r from-pink-800 to-red-700 text-white px-6 sm:px-10 py-6 mt-8 pt-5 rounded-t-[3rem] md:rounded-t-[5rem]">
      <h2 className="text-2xl sm:text-2xl text-center pb-2">
      ...
      <div className="flex flex-wrap justify-between gap-6 md:gap-0">
        ...
        <div className="flex flex-col gap-3 max-w-sm">
          ...
          <p className="text-white text-base sm:text-sm italic">
        ...
        {/* Right Section */}
        <div>
          <h3 className="text-lg sm:text-lg">Contact Us</h3>
          <div className="mt-2 space-y-2 text-sm sm:text-base">
            ...
            <div className="flex items-center gap-2 text-white transition-transform transform hover:scale-110 duration-300 ease-in-out">
              ...
              <span className="text-xs">+91 9999955555</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <p className="text-center text-white text-sm sm:text-xs">
        © 2025 MARKLE TECH & MEDIA PVT LTD. All rights reserved.
      </p>
      <p className="text-center text-white text-xs sm:text-xs ">
      ...
      <div className="flex flex-wrap justify-center gap-4 text-white mt-3 text-xs sm:text-[10px]">
